...
abstract class BaseGradientNavigationActivity : AppCompatActivity() {
    ...
    abstract val layoutBottomBarRes: GradientNavigationBarLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listener = GradientPageChangeListener(viewPager, fragmentList, layoutBottomBarRes, navigationBar)
